  ...
  import { fetchClientSessions, updateSession, deleteSession} from '../features/sessionSlice';
  ...
  console.log(sessions ," client");
    ...
    const handleUpdate = (session) => {
      const updatedSessionData = {
        ...
        updatedData: {
          sessionNotes: {
            privateNotes: updatedData.privateNotes,
    ...
    return (
      <div className="min-h-screen">
        <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6">
          <h2 className="text-2xl font-bold text-gray-800 mb-6">Your Sessions</h2>
                ...
                {sessions.map((session) => (
                  ...
                  >
                    <p className="text-sm text-gray-500">
                      <span className="font-bold">Therapist:</span> {session.therapistId?.name || 'Unknown'}
                    </p>
                    <p className="text-sm text-gray-500">
